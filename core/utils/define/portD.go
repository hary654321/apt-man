...
type PortScan struct {
	...
	// MatchRegexString string `gorm:"column:ip" json:"MatchRegexString"`
	// OperatingSystem  string `gorm:"column:ip" json:"OperatingSystem"`
	// CreateDate       string `gorm:"column:ip" json:"CreateDate"`
	// DeviceType       string `gorm:"column:ip" json:"DeviceType"`
	// Hostname         string `gorm:"column:ip" json:"Hostname"`
}
...
var TOP_1000 = []int{80, 442, 22, 25, 3306, 8080, 21, 9000, 8443, 8089, 21, 23, 25, 81, 88, 89, 110, 3389, 135, 445, 139, 137,
	143, 389, 512, 513, 514, 548, 873, 1433, 1521, 2181, 3690, 4848, 5000, 7547, 5060,
	...
	10024, 10200, 333, 73, 8054, 6372, 223, 3737, 9800, 9019, 8067, 45692, 15400, 15698,
