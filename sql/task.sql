...
CREATE TABLE `task` (
	...
	`name` VARCHAR(30) NOT NULL DEFAULT '' COMMENT '任务名称' COLLATE 'utf8mb4_general_ci',
	`group` VARCHAR(30) NOT NULL DEFAULT '' COMMENT '分组' COLLATE 'utf8mb4_general_ci',
	...
	`probeId` VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '规则ID' COLLATE 'utf8mb4_general_ci',
	`plug` VARCHAR(1000) NOT NULL DEFAULT '' COLLATE 'utf8mb4_general_ci',
...
;
ALTER TABLE `task`
	ADD COLUMN `group` VARCHAR(30) NOT NULL DEFAULT '' COMMENT '分组' AFTER `name`;
